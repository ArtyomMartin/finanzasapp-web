export default function Privacidad() {
  return (
    <div style={{ maxWidth: "700px", margin: "0 auto", padding: "60px 24px", color: "#C7CDD6", lineHeight: "1.8" }}>
      <h1 style={{ fontSize: "28px", fontWeight: "bold", marginBottom: "24px" }}>Política de Privacidad</h1>

      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>1. INFORMACIÓN GENERAL</h2>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>2. DATOS QUE ALMACENAMOS</h2>
      <p style={{ marginBottom: "16px" }}>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>3. SINCRONIZACIÓN CON GOOGLE DRIVE (OPCIONAL)</h2>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>4. SINCRONIZACIÓN CON DROPBOX (OPCIONAL)</h2>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>5. DATOS QUE NO RECOPILAMOS</h2>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>6. COMPARTICIÓN DE DATOS CON TERCEROS</h2>
      <p style={{ marginBottom: "16px" }}>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>7. SEGURIDAD</h2>
      <p style={{ marginBottom: "16px" }}>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>8. MENORES DE EDAD</h2>
      <p style={{ marginBottom: "16px" }}>
      ...
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>9. CAMBIOS EN ESTA POLÍTICA</h2>
      <p style={{ marginBottom: "16px" }}>
        Esta política refleja el funcionamiento actual de la app. Cualquier cambio futuro se publicará en esta misma URL.
      </p>

      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginTop: "32px", marginBottom: "12px" }}>10. CONTACTO</h2>
      <p style={{ marginBottom: "16px" }}>
